...
export async function composeDraft(ai:Env['AI']|undefined,model:string|undefined,input:DraftInput,signal:AbortSignal=AbortSignal.timeout(60_000)):Promise<DraftNote>{
